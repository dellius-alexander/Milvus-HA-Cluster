...
graph TD
    ...
    subgraph External_Network["external-network"]
        ...
        style HAProxy fill:#1505a8,stroke:#ff00ff,stroke-width:2px
    end
    ...
    subgraph Milvus_Network["milvus-network"]
        ...
        style MilvusEntrypoint fill:#1505a8,stroke:#ff00ff,stroke-width:2px
    ...
    subgraph Etcd_Network["etcd-network"]
        ...
        style EtcdProxy fill:#1505a8,stroke:#ff00ff,stroke-width:2px
